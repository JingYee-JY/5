...
const items = [
    { name: "wrong", image: "./assets/img/8 79 Card.png" },
    { name: "correct", image: "./assets/img/Fortune Teller Card.png" },
    { name: "wrong", image: "./assets/img/1976 Card.png" }
];
        ...
        card.addEventListener("click", () => {
            if (pickCard == false) {
                ...
                if (cardName == "wrong") {
                    ...
                    endText.innerHTML = "<p>Jaafar Latiff's <i>Fotune Teller</i> is the artwork <b>not</b> from the Wandering Series, unlike the other two artworks.</p>"
                    ...
                    endText.innerHTML = "<p>Jaafar Latiff's <i>Fotune Teller</i> is indeed not from the Wandering Series, unlike the other two artworks.</p"
...
const initializer = () => {
    instruction.innerHTML = "<p class='resultText'>Follow and identify the artwork that is not from the series.</p>"
    winCount = 0;
